...
reviews = reviews[
    ['review_date', 'hotel_name', 'hotel_address', 'average_score', 'reviewer_nationality', 'reviewer_score',
     'negative_review', 'positive_review', 'total_number_of_reviews_reviewer_has_given', 'lat', 'lng']]

reviews.rename(columns={'hotel_name': 'Hotel', 'hotel_address': 'Hotel Address', 'average_score': 'Average Rating',
                        'review_date': 'Review Date', 'reviewer_nationality': 'Reviewer Nationality',
                        'reviewer_score': 'Reviewer Score', 'negative_review': 'Negative Review',
                        'positive_review': 'Positive Review',
                        'total_number_of_reviews_reviewer_has_given': 'Total User Reviews Submitted', 'lat': 'Lat',
...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            ...
            html.H5(children='A hotel visualization, based on reviews',
        ...
        ], style={'padding-left': '5%'}, className='four columns')
    ...
    html.Div([
        dcc.Tabs([
            ...
            dcc.Tab(label='About', children=[
                html.P(
                    id='about',
                    children=['This project began with a question: ',
                              html.B('Do people from different nationalities rate the same hotels differently? '),
    ...
    html.Div([
        ...
        html.Div([
            dash_table.DataTable(
                ...
                style_cell={
                    'minWidth': '140px', 'width': '140px', 'maxWidth': '300px',
                    'overflow': 'hidden',
    ...
    html.Div([
        ...
        dcc.Textarea(
            ...
            readOnly=True,
            style={'width': '100%', 'fontFamily': 'HelveticaNeue', 'fontWeight': 'normal'}
        )
    ]),

    # Negative Review
    html.Div([
        html.H5(id='negative-textbox-header', children='Negative Review', style={'text-align': 'center'}),
        dcc.Textarea(
            id='negative-textbox',
                 ...
                 html.P(style={'textAlign': 'center', 'margin': 'auto'},
                        children=['Full project on ',
                                  html.A('GitHub',
                                         ...
                                         target='_blank'),
                                  " | Developed by ",
                                  html.A('Sebastian Rosado', href='https://www.linkedin.com/in/srosadomustafa/',
                                         target='_blank'
                                         ), " | Thanks for visiting 👋"
                                  ])
             ])
...
def update_map_location(value):
    ...
    fig2.update_layout(
        ...
        mapbox=go.layout.Mapbox(
            ...
            bearing=0,
            center=go.layout.mapbox.Center(
                lat=48.7329446 if value == 'Anywhere'
                else dff.loc[dff['city'] == value, 'lat'].values[0],
                lon=5.0126286 if value == 'Anywhere'
