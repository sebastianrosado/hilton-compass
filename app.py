                    ...
                    dcc.Tabs([
                        dcc.Tab(label='Home', children=[
                            html.P(
                                id='home',
                                children=[
                                'In an age where the consumer increasingly relies on algorithms in order to make decisions about where to eat, what to watch and where to sleep, hotel reviews matter. In fact, your hotel\'s reputation can be the difference between being profitable and losing money. Studies ',
                                 html.A('suggest ',
                        ...
                        dcc.Tab(label='About', children=[
                            html.P(
                                ...
                                children=['This project began with a question: ',
                                        html.B('Do people from different nationalities rate the same hotels differently? '), 'I found a dataset scraped from public reviews on Booking.com and posted on ',
                                        html.A('Kaggle',
